...
test.describe('Crypto Trading Platform - Critical Workflows', () => {
  ...
  test.describe('♿ Accessibility Compliance', () => {
    ...
    test('should have proper ARIA labels and roles', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="emergency-stop-button"]'))
        .toHaveAttribute('aria-label', 'Emergency stop all trading operations');
      
      await expect(page.locator('[data-testid="price-chart"]'))
        .toHaveAttribute('role', 'img');
      
      await expect(page.locator('[data-testid="order-book"]'))
