...
export class TestHelpers {
  ...
  async waitForNotification(expectedText?: string) {
    const notification = this.page.locator('[role="alert"], .notification, [data-testid="notification"]');
  ...
  async testThemeSwitch() {
    ...
    const themeSelector = this.page.locator('[data-testid="theme-selector"], .theme-selector, button:has-text("Theme")');
