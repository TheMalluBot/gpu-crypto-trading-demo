...
export const TRADING_SYMBOLS = ['BTCUSDT', 'ETHUSDT', 'ADAUSDT', 'DOTUSDT', 'LINKUSDT'] as const;
...
export const VALID_TEST_CREDENTIALS = {
  ...
  ed25519: {
    ...
    api_secret:
      'test_ed25519_private_key_base64_encoded_mock_data_for_testing_purposes_only_not_real',
    type: 'Ed25519' as const,
  },
};
