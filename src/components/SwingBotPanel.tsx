...
const SwingBotPanel: React.FC = React.memo(() => {
  ...
  return (
    <ErrorBoundary>
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-x-hidden">
        {/* Enhanced Dashboard Header */}
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
          {/* Left: Status & Live Price */}
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <h1 className="text-hierarchy-primary">GPU Trading Dashboard</h1>

            {/* Enhanced Live Price Card */}
            <div className="glass-morphic p-4 rounded-xl border border-primary-500/20">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
                <div>
                  <div className="text-xs text-gray-400 uppercase tracking-wide">BTC/USDT Live</div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center space-x-2 glass-morphic p-2 rounded-lg">
              <button
                onClick={botStatus?.is_running ? toggleBot : toggleBot}
            ...
            <button
              ...
              className="btn-theme-secondary text-sm px-3 py-2"
            ...
            <button
              ...
              className="btn-theme-primary text-sm px-4 py-2"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <AutomatedAssetManagerStatus assetManager={assetManager} />
          </div>

          {/* Right Column: Charts & Performance */}
          <div className="lg:col-span-2 space-y-4">
            {/* Enhanced Signal Chart with GPU Acceleration */}
        ...
        {/* Bottom Section: Portfolio & Signals */}
