...
export const BotOnboardingModal: React.FC<BotOnboardingModalProps> = ({
  ...
  const steps = [
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-blue-700">Your AI-powered trading assistant is ready to help you trade smarter, not harder.</p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <div>
              ...
              <p className="text-green-700">Paper trading lets you test strategies with virtual money—no real funds at risk!</p>
            </div>
          </div>
          ...
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-blue-800 text-sm">
              <strong>Recommendation:</strong> Always start with paper trading to understand how the bot works before considering live trading.
            </p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-700">Your bot can be in several states. Here's what each means:</p>
          <div className="space-y-3">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              <span className="text-2xl">⏸️</span>
              <div>
                <h4 className="font-semibold text-gray-800">Stopped</h4>
                <p className="text-sm text-gray-600">Bot is idle and not monitoring markets. Safe default state.</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">Bot is monitoring markets and executing trades automatically.</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-orange-600">Trading paused due to risk limits. Automatic safety feature.</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-red-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-red-600">All trading stopped immediately. Requires manual reset.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 bg-green-500 text-white rounded text-xs flex items-center justify-center">▶️</span>
                  <span><strong>Start Bot:</strong> Begin monitoring markets</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 bg-gray-500 text-white rounded text-xs flex items-center justify-center">⏸️</span>
                  <span><strong>Stop Bot:</strong> Pause trading activity</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="w-6 h-6 bg-red-500 text-white rounded text-xs flex items-center justify-center">🚨</span>
                  <span><strong>Emergency Stop:</strong> Immediate halt</span>
                </div>
              </div>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span><strong>Stop Loss:</strong> Automatic loss protection</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-green-500">🎯</span>
                  <span><strong>Take Profit:</strong> Secure gains automatically</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-green-500">⚡</span>
                  <span><strong>Circuit Breakers:</strong> Daily loss limits</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-green-500">⏰</span>
                  <span><strong>Position Limits:</strong> Maximum hold times</span>
                </div>
              </div>
            </div>
          </div>
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-yellow-800 text-sm">
              <strong>Important:</strong> The bot will NEVER start automatically. You have complete control over when it starts and stops.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border">
            ...
            <div>
              ...
              <p className="text-gray-700">Your trading bot is configured and ready to use in paper trading mode.</p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Click "Configure Bot" to adjust timeframes, risk settings, and strategy presets</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Click "Start Bot" when you're ready to begin virtual trading</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Watch the charts and metrics to understand how your strategy performs</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-green-800 text-sm">
              <strong>Remember:</strong> You're in complete control. The bot will only do what you tell it to do, when you tell it to do it.
            </p>
          </div>
        </div>
      )
