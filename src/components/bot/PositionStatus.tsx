...
export const PositionStatus: React.FC<PositionStatusProps> = ({
  botStatus,
  config
}) => {
  return (
        ...
        <div className="space-y-4">
          ...
          {botStatus.current_position.stop_loss && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-red-400 font-medium">${botStatus.current_position.stop_loss.toFixed(2)}</span>
            </div>
          )}
          ...
          {botStatus.current_position.take_profit && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-green-400 font-medium">${botStatus.current_position.take_profit.toFixed(2)}</span>
            </div>
          )}
        </div>
      ) : (
