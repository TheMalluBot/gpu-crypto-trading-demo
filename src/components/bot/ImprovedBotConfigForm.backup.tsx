    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg text-white font-medium transition-colors focus-enhanced"
          aria-label="Open preset configurations"
        >
      ...
      <div className="border-b border-white/20">
        <nav className="flex space-x-8" role="tablist" aria-label="Configuration sections">
          {[
            ...
            <button
              ...
              className={`flex items-center space-x-2 py-3 px-1 border-b-2 transition-colors focus-enhanced ${
                activeTab === id
