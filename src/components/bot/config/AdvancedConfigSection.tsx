        ...
        <div className="space-y-4">
          ...
          {marketConditions && (
            <div className="mt-4 p-4 bg-theme-surface rounded-lg border border-theme-border">
              <h4 className="text-sm font-medium text-theme-primary mb-2">Current Market Analysis</h4>
          ...
          {(config.auto_resume_enabled ?? true) && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-7">
              <ConfigInput
                ...
                onChange={(value) => onConfigChange('volatility_resume_threshold_multiplier', Number(value))}
                min={0.1}
                max={1.5}
                step={0.1}
              ...
              <ConfigInput
                ...
                onChange={(value) => onConfigChange('data_quality_resume_delay_minutes', Number(value))}
                min={1}
                max={30}
              ...
              <ConfigInput
                ...
                onChange={(value) => onConfigChange('flash_crash_resume_delay_minutes', Number(value))}
                min={5}
                max={180}
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-theme-secondary">
                      Current Balance: <span className="font-mono text-theme-primary">${botStatus?.account_balance?.toLocaleString() || 'Loading...'}</span>
                    </div>
