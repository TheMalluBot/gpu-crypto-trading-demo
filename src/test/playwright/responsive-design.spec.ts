...
test.describe('Asset Manager Panel Responsive Design', () => {
  ...
  test('should adapt to mobile breakpoints', async ({ page }) => {
    ...
    if (await assetManagerButton.isVisible()) {
      ...
      await responsiveHelper.checkGridLayout('.grid.grid-cols-1.sm\\:grid-cols-2.lg\\:grid-cols-4', 1);
  ...
  test('should adapt to tablet breakpoints', async ({ page }) => {
    ...
    if (await assetManagerButton.isVisible()) {
      ...
      await responsiveHelper.checkGridLayout('.grid.grid-cols-1.sm\\:grid-cols-2.lg\\:grid-cols-4', 2);
  ...
  test('should adapt to desktop breakpoints', async ({ page }) => {
    ...
    if (await assetManagerButton.isVisible()) {
      ...
      await responsiveHelper.checkGridLayout('.grid.grid-cols-1.sm\\:grid-cols-2.lg\\:grid-cols-4', 4);
