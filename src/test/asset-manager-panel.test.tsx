...
describe('AssetManagerPanel', () => {
  ...
  it('handles empty profit actions gracefully', async () => {
    ...
    mockAssetManager.mockImplementation(() => ({
      getState: vi.fn().mockReturnValue({
        config: { asset_classes: [], risk_buckets: [], profit_zones: [], rebalancing_frequency: 'weekly', total_capital: 0 },
        portfolio_health: { overall_score: 0, allocation_health: 0, risk_health: 0, profit_health: 0, warnings: [], recommendations: [] },
