...
describe('AutomationConfigPanel', () => {
  ...
  it('saves configuration when save button is clicked', async () => {
    ...
    render(<AutomationConfigPanel {...defaultProps} onClose={onClose} assetManager={assetManager} />);
  ...
  it('maintains state across tab switches', async () => {
    ...
    const toggleAfter = screen.getByText('Enable Automation').parentElement?.querySelector('button');
